...
export default function Works_banner() {
  ...
  return (
        <div className='w-[70%] h-64 mx-4 bg-white my-24 flex justify-center 
        py-2 px-4 rounded-3xl shadow-lg hover:cursor-pointer hover:bg-orange-300 transition-all' onClick={()=> handleClick('/works')}>
            <div className='w-[520px] flex flex-col mt-8'>
                <div className='text-7xl w-full flex justify-start p-1 font-semibold
                '>Explore to</div>
