...
export default function ProjectForm() {
  ...
  return isClient ? createPortal(
    <main className="w-full h-full flex justify-center absolute z-50 top-0 left-0">
            <div className="w-full h-[36rem] bg-white mx-40 mt-24 rounded-3xl px-4 py-4 shadow-md">
              ...
              <div className="scroll-layout w-full h-5/6 overflow-y-scroll flex justify-between">
                <div className="w-1/2 mx-8 pr-24 ">
                  ...
                  <textarea placeholder="information about project" className="w-full min-h-44 max-h-80 overflow-y-hidden 
